...
{
    public class AbpOnDockerDbMigrationService : ITransientDependency
    {
        public ILogger<AbpOnDockerDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IAbpOnDockerDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public AbpOnDockerDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IAbpOnDockerDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<AbpOnDockerDbMigrationService>.Instance;
        }
