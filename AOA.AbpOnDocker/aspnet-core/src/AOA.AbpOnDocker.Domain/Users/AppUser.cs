...
namespace AOA.AbpOnDocker.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpOnDockerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpOnDockerEfCoreEntityExtensionMappings to extend the IdentityUser entity
